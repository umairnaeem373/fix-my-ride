...
function HexagonBackground({
  ...
  return (
    <div
      ...
      className={cn(
        'relative size-full overflow-hidden dark:bg-primary/40 bg-primary/20',
        className,
      )}
      {...props}
    >
              ...
              (_, colIndex) => (
                <div
                  ...
                  className={cn(
                    ...
                    'hover:cursor-pointer hover:before:bg-primary/50 dark:hover:before:bg-primary/70 hover:before:opacity-100 hover:before:duration-0 dark:hover:after:bg-neutral-900 hover:after:bg-neutral-100 hover:after:opacity-100 hover:after:duration-0',
